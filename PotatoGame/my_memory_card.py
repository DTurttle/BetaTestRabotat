...
questions_list.append(Question('Сколько цветов в радуге ?', '7', '8', '6', '5'))
questions_list.append(Question('Какого супер героя нету в Marvel ?', 'Бэтмен', 'Человек-Паук', 'Железный Человек', 'Халк'))
questions_list.append(Question('Каких наборов нету в Lego ?', 'Три богатыря', 'Star Wars', 'DC', 'Marvel'))
app = QApplication([])
